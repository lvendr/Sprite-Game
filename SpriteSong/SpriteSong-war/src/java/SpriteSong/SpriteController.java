...
import SpriteSong.util.JsfUtil;
import SpriteSong.util.PaginationHelper;
 ...
 * Lab Prof: Todd Kelley
 * Lab#: 301
 * Class: SpriteConverter
 * Methods: SpriteController(), getSelected(), getFacade(), getPagination(),
 *          prepareList(), prepareView(), create(), prepareEdit(), update(), destroy(), 
 *          destroyAndView(), performDestroy(), updateCurrentItem(), getItems(),
 *          recreateModel(), recreatePagination(), next(), previous(), 
 *          getItemsAvailableSelectMany(), getItemsAvailableSelectOne(), 
 *          getSprite(java.lang.Long id)
 * Class: SpriteController
 * Methods: getAsObject(FacesContext facesContext, UIComponent component, String value),
 *          getKey(String value), getStringKey(java.lang.Long value), 
 *          getAsString(FacesContext facesContext, UIComponent component, Object object)
 * Description: Handling the logic of presentation layer, mapping between Presentation and Data layers
 */
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private cst8218.nguy0770.entity.SpriteFacade ejbFacade;
    ...
    private cst8218.nguy0770.entity.SpriteFacade getFacade() {
        return ejbFacade;
    }
