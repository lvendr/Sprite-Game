...
import cst8218.nguy0770.entity.AppUser;
 ...
 * Methods: AppUserController(), getSelected(), getFacade(), getPagination(),
...
public class AppUserController implements Serializable {
    ...
    @EJB
    private cst8218.nguy0770.entity.AppUserFacade ejbFacade;
    ...
    private cst8218.nguy0770.entity.AppUserFacade getFacade() {
        return ejbFacade;
    }
